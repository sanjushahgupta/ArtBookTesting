package com.digitalaya.artbooktesting.adapter
   ...
   private val diffUtil = object : DiffUtil.ItemCallback<Art>(){
    ...
    override fun onBindViewHolder(holder: ArtViewHolder, position: Int) {
     val imageView = holder.itemView.findViewById<ImageView>(R.id.artRowImageView)
        val nameText = holder.itemView.findViewById<TextView>(R.id.artRowName)
        val artistNameText = holder.itemView.findViewById<TextView>(R.id.artRowArtistName)
